  ...
  return knex('contacts').del()
    .then(function () {
      return knex('contacts').insert([
        {user_id: 1, first_name: 'Dwight', last_name: 'Schrute', company: "Dunder Mifflin", profession: "Sales", email: "dwight@dm.com", phone: "(828) 929-3949", photo_url: "https://pbs.twimg.com/profile_images/549268771484229632/WnatiHzT.jpeg"},
